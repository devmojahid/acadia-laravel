        ...
        <div class="tpd-setting-box profile">
            ...
            <div class="tpd-setting-from">
                <div class="row">
                    ...
                    <x-user::profile-input-text label="User Name" name="username" value="{{ $user->username }}" />
                    <x-user::profile-input-text label="Phone Number" name="phone" value="{{ $user->getMeta('phone') }}"
                        placeholder="(+44) 433 962 004" />
