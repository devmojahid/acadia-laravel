                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="tp-login-input p-relative">
                                <x-user::input-label for="email" :value="__('Email')" />
                                <x-user::text-input id="email" type="email" name="email" :value="old('email')"
                                    autocomplete="email" placeholder="{{ __('Type your email') }}" class="is-invalid" />
                        ...
                        <div class="col-12">
                            <div class="tp-login-from-btn">
                                <button class="tp-btn-inner w-100 text-center">{{ __('Reset Password') }}</button>
                            </div>
                        </div>
                    </div>
                </form>
