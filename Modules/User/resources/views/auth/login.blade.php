...
@section('content')
    <div class="tp-login-from-box">
        <div class="tp-login-from-heading text-center">
            ...
            <p> {{ __('Dont have an account?') }} <a href="{{ route('register') }}"> {{ __('Create Now') }}</a></p>
        </div>
        <div class="tp-login-input-form">
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="tp-login-input p-relative">
                            <x-user::input-label for="password" :value="__('Password')" />
                            <div>
                                <div class="password-input p-relative">
                                    <x-user::text-input id="password" type="password" name="password" :value="old('password')"
                                        autocomplete="new-password" placeholder="{{ __('Type your password') }}"
                                        class="is-invalid" />
                            ...
                            <x-user::input-error class="d-block" :messages="$errors->get('password')" />
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="tp-contact-input-remeber login">
                                        ...
                                        <x-user::input-label for="remeber" :value="__('Save account')" />
                                    </div>
                                </div>
                        ...
                        <div class="tp-login-from-btn">
                            <button class="tp-btn-inner w-100 text-center">{{ __('Sign In') }}</button>
                        </div>
