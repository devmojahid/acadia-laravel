                ...
                <div class="row">
                    <div class="col-12">
                        <div class="tp-login-input p-relative">
                            <x-user::input-label for="name" :value="__('Full Name')" />

                            <x-user::text-input id="name" type="text" name="name" :value="old('name')"
                                autocomplete="name" placeholder="{{ __('Type your name') }}" class="is-invalid" />
                    ...
                    <div class="col-12">
                        <div class="tp-login-input p-relative">
                            <x-user::input-label for="password_confirmation" :value="__('Confirm Password')" />
                            <div>
                                <div class="password-input p-relative">
                                    <x-user::text-input id="password_confirmation" type="password"
                                        name="password_confirmation" :value="old('password_confirmation')" autocomplete="new-password"
                                        placeholder="{{ __('Type your password') }}" class="is-invalid" />
                                ...
                                <x-user::input-error :messages="$errors->get('password_confirmation')" />
                            </div>
                        </div>
                    </div>
                    <div class="col-12">
                        ...
                        <div class="tp-login-from-btn">
                            <button class="tp-btn-inner w-100 text-center">{{ __('Register') }}</button>
                        </div>
